...
def get_todos(filepath=r"C:\Users\Utente\Python\IdeaProjects\CourseNew\Files\todos.txt"):
...
def write_todos(todos_arg, filepath=r"C:\Users\Utente\Python\IdeaProjects\CourseNew\Files\todos.txt"):
